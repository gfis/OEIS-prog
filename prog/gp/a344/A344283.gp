/* source=https://oeis.org/A344283 lang=pari curno=1 type=print rev=4 offset=1 bfimax=68 nstart=1 */
...
printfromvec(vec) = for(k=1, #vec, if(vec[k][1]==vec[k][#vec[k]], print(vec[k][2])));
