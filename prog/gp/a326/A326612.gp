/* source=https://oeis.org/A326612 lang=pari curno=1 type=print rev=28 offset=1 bfimax=10000 nstart=1 */
...
print(r=1); for(n=2, 1000, if(a(n)>r, r=a(n); print(n))) /* after _Charles R Greathouse IV_ in A001175*/
