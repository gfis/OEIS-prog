/* source=https://oeis.org/A293662 lang=pari curno=1 type=print rev=7 offset=1 bfimax=50 nstart=1 */
...
forprime(p=1, , if(vecmin(digits(p, 9))!=vecmax(digits(p, 9)), if(is_circularprime(p, 9), print(p))));
