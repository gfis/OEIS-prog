/* source=https://oeis.org/A293659 lang=pari curno=1 type=print rev=14 offset=1 bfimax=5 nstart=1 */
...
forprime(p=1, , if(vecmin(digits(p, 6))!=vecmax(digits(p, 6)), if(is_circularprime(p, 6), print(p))));
