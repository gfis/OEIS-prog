/* source=https://oeis.org/A293661 lang=pari curno=1 type=print rev=10 offset=1 bfimax=42 nstart=1 */
...
forprime(p=1, , if(vecmin(digits(p, 8))!=vecmax(digits(p, 8)), if(is_circularprime(p, 8), print(p))));
