/* source=https://oeis.org/A293660 lang=pari curno=1 type=print rev=13 offset=1 bfimax=141 nstart=1 */
...
forprime(p=1, , if(vecmin(digits(p, 7))!=vecmax(digits(p, 7)), if(is_circularprime(p, 7), print(p))));
