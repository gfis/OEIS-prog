/* source=https://oeis.org/A293658 lang=pari curno=1 type=print rev=17 offset=1 bfimax=24 nstart=1 */
...
forprime(p=1, , if(vecmin(digits(p, 5))!=vecmax(digits(p, 5)), if(is_circularprime(p, 5), print(p))));
