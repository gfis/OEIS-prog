/* source=https://oeis.org/A303980 lang=pari curno=1 type=an rev=22 offset=0 bfimax=31 nstart=0 */
...
a(n) = if (n <= 2, 1, res = a027376(n)/2 - sum(i=2, n-1, i*T303979(n,i)); if (!(n%2), res += a006575(n/2)/2); res);
a(n);
