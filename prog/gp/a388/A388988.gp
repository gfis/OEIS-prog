/* source=https://oeis.org/A388988 lang=pari curno=1 type=an rev=7 offset=1 bfimax=22155 */
;
up_to_cols = 210;
A326128(n) = (n-core(n));
...
A388988sq(row,col) = A326128(A388981sq(row,col));
A388988list(up_to) = { my(v = vector(up_to), i=0); for(a=1,oo, for(col=1,a, i++; if(i > up_to, return(v)); v[i] = A388988sq(col,(a-(col-1))))); (v); };
v388988 = A388988list(up_to);
A388988(n) = v388988[n];
a(n)=A388988(n);
