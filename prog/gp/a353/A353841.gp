/* source=https://oeis.org/A353841 lang=pari curno=1 type=an rev=15 offset=1 bfimax=65537 */
;
...
A353841(n) = if(1==n,0,for(i=1,oo,if(issquarefree(n), return(i), n = A353832(n))));
a(n)=A353841(n);
